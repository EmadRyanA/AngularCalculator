...
export class AppComponent {
  ...
  subText = '0'; // The text that should appear in the sub-display
  mainText = '0'; // The text that should appear in the main display
  ...
  allClear(){
  this.subText = '0'; // The text that should appear in the sub-display
  this.mainText = '0'; // The text that should appear in the main display
